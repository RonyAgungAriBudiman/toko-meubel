...
if(isset($_POST['Update']))
{
	...
	$sql_upd = "UPDATE ms_pengeluaran set Tanggal = '".date("Y-m-d",strtotime($_POST['tanggal']))."', 
									Keterangan = '".$_POST['keterangan']."',
									Nominal = '".$_POST['nominal']."'	
				WHERE PengeluaranID ='".$_POST['pengeluaranid']."'  ";
...
{
	$sql_del="DELETE FROM ms_pengeluaran WHERE PengeluaranID ='".$_POST['pengeluaranid']."'	";
						...
						<form method="post">
							...
							<div class="col-md-4">
								...
								<?php if($_SESSION["level"]=="4" OR $_SESSION["level"]=="9"){?>
									<a href="index.php?m=<?php echo acakacak("encode","bendahara/pengeluaran")?>&sm=<?php echo acakacak("encode","add")?>&p=<?php echo acakacak("decode",$_GET["p"]) ?>">
            	...
            	<div class="box-body">
              		<div class="table-responsive">  
		                ...
		                <tbody>
		                	<?php
		                	$no=1;
		                	$sql = "SELECT a.PengeluaranID,	a.Tanggal, a.Keterangan, a.Nominal	
							...
							{ 	
		                		...
		                		<tr>
									...
									<td style="text-align: center;">
										<button type="button" class="btn btn-success" data-toggle="modal"
														data-target="#Modaledit<?php echo $row['PengeluaranID']; ?>">
								...
								<!--modal edit -->
								<div class="modal fade" id="Modaledit<?php echo $row['PengeluaranID']; ?>" tabindex="-1" role="dialog" 
            						...
            						<div class="modal-dialog" role="document">
            						    <div class="modal-content">
            						      ...
            						      <?php 
            						      	$sql = "SELECT * FROM ms_pengeluaran WHERE PengeluaranID = '".$row['PengeluaranID']."' ";
            						      	$data= $sqlLib->select($sql);
            						      	$_POST['pengeluaranid'] = $data[0]['PengeluaranID'];
            						      ...
            						      ?>
	            						    ...
	            						    <div class="modal-footer">
	            						    	<input type="hidden" class="form-control" name="pengeluaranid" id="pengeluaranid" value="<?php echo $_POST["pengeluaranid"] ?>">
